...
export default function Requirements() {
  const columns = ["No.", "Program", "Number of Students"];
  const rows = [
    { items: [1, "BSc", 46] },
    { items: [2, "M.Sc.", 20] },
    { items: [3, "PhD", 6] },
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="pl-6">
            <ul>
              ...
              <li className="list-disc text-sm">
                the performance of the applicant in the M.Sc. entrance
                examination must be satisfactory as assessed and decided by the
                DGC
              </li>
              <li className="list-disc text-sm">
                the applicant must also meet the general admission requirements
          ...
          <p className="text-sm text-gray-600">
            ...
            department graduate committee. All applicants from related fields
            that have scored pass grades {"(>=”C”)"} in all remedial courses are
        ...
        <div className="w-full md:w-1/2">
          <div className="py-3">
            ...
            <ol className="py-3 list-disc pl-6 text-sm">
              ...
              <li>
                who will pass a qualifying examination may be admitted to the
